...
export default async function documentCardComponent(document) {
    ...
    /* Creating the HTML required for the options. */ {
        ...
        if ( Object.keys(instance).length === 0 ) userOptions = ( userOptions + 
    ...
    /* Creating the HTML required for the options. */ {
        ...
        if ( Object.keys(instance).length === 0 ) customerOptions = ( customerOptions + 
            ...
            <form hx-post="${apiEndpoint}" hx-trigger="submit" class="relative flex flex-col p-4"
                ...
                <div>
                    <div class="form-group flex-grow">
                        ...
                        <input  id="${cardID}-created-on" class="default cursor-not-allowed" 
                            value="${document?.dateCreated.toISOString()}" name="dateCreated" readonly>
                    </div>
                ...
                <div class="p-3 grid grid-cols-3 w-full mt-auto">
                    <div class="flex justify-center">
                        <button hx-delete="${apiEndpoint}" hx-target="#${cardID}" 
                            hx-confirm="Are you sure you want to delete document '${document[EntityId]}'? The consequences of this action cannot be undone."
